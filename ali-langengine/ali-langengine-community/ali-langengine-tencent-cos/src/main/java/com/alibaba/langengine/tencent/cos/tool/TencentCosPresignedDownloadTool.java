...
@Slf4j
public class TencentCosPresignedDownloadTool extends BaseTool {

    public TencentCosPresignedDownloadTool() {
        setName("TencentCos.get_presigned_url_download");
    ...
    public ToolExecuteResult run(String toolInput, ExecutionContext executionContext) {
        ...
        try {
            ...
            GeneratePresignedUrlRequest req = new GeneratePresignedUrlRequest(bucket, key, com.qcloud.cos.http.HttpMethodName.GET);
            ...
            log.error("TencentCos.get_presigned_url_download failed", e);
