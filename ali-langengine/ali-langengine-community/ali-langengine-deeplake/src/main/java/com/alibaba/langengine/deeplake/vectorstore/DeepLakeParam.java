...
public class DeepLakeParam {
    ...
    public static class InitParam {
        private String datasetName = "langengine_deeplake_collection";
        ...
        private String description = "LangEngine Deep Lake Vector Store";
    }
    ...
    public static class Builder {
        private DeepLakeParam param = new DeepLakeParam();

        public Builder datasetName(String datasetName) {
            param.getInitParam().setDatasetName(datasetName);
            return this;
        }
        ...
        public Builder isPublic(Boolean isPublic) {
            param.getInitParam().setIsPublic(isPublic);
            return this;
        }
