...
import com.alibaba.langengine.volcenginetranslate.tools.VolcengineTranslateTool;
 ...
 */
@Slf4j
public class VolcengineTranslateToolFactory {
    ...
    public List<BaseTool> getAllTools() {
        ...
        log.info("Created {} Volcengine Translate tools", tools.size());
        return tools;
    }
    ...
    public List<String> getSupportedToolTypes() {
        return Arrays.asList("volcengine_translate");
    }
    ...
    public BaseTool getTranslateTool() {
        return new VolcengineTranslateTool();
    }
}
