...
public class ArcNeuralServiceTest {

    private ArcNeuralService service;
    private FakeEmbeddings fakeEmbeddings;

    @BeforeEach
    public void setUp() {
        service = new ArcNeuralService("http://localhost:8080", "user", "pass", "test_collection", null);
    ...
    public void testConstructorWithParam() {
        ...
        ArcNeuralService serviceWithParam = new ArcNeuralService(
