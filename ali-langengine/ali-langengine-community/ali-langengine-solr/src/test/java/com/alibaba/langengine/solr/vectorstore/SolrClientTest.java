...
public class SolrClientTest {
    ...
    private SolrParam param;

    @BeforeEach
    public void setUp() {
        param = new SolrParam();
        client = new SolrClient("http://localhost:8983/solr", "testuser", "testpass", param);
    }
    ...
    public void testConstructorWithNullUsername() {
        assertThrows(IllegalArgumentException.class, () -> 
            new SolrClient("http://localhost:8983/solr", null, "testpass", param));
    }

    @Test
    public void testConstructorWithNullPassword() {
        assertThrows(IllegalArgumentException.class, () -> 
            new SolrClient("http://localhost:8983/solr", "testuser", null, param));
    }
