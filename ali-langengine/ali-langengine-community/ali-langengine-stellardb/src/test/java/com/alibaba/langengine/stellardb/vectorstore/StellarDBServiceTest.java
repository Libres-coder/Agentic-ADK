...
public class StellarDBServiceTest {

    private StellarDBService service;
    private FakeEmbeddings fakeEmbeddings;

    @BeforeEach
    public void setUp() {
        service = new StellarDBService("http://localhost:8080", "user", "pass", "test_collection", null);
    ...
    public void testConstructorWithParam() {
        ...
        StellarDBService serviceWithParam = new StellarDBService(
            "http://localhost:8080", "user", "pass", "test_collection", param);
