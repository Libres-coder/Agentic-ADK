...
public class NebulaGraphParam {
    ...
    public static class InitParam {
         ...
         * 向量维度
         */
        private int dimension = NebulaGraphConfiguration.DEFAULT_VECTOR_DIMENSION;
        
        /**
         * 距离函数类型
         */
        private String distanceFunction = NebulaGraphConfiguration.DEFAULT_DISTANCE_FUNCTION;
        
        /**
         * 相似度阈值
         */
        private double similarityThreshold = NebulaGraphConfiguration.DEFAULT_SIMILARITY_THRESHOLD;
        
        /**
         * 批处理大小
         */
        private int batchSize = NebulaGraphConfiguration.DEFAULT_BATCH_SIZE;
        
        /**
         * 最大缓存大小
         */
        private int maxCacheSize = NebulaGraphConfiguration.DEFAULT_MAX_CACHE_SIZE;
        
        /**
         * 连接超时时间
         */
        private int timeoutMs = NebulaGraphConfiguration.DEFAULT_TIMEOUT_MS;
         ...
         * 连接池大小
         */
        private int connectionPoolSize = NebulaGraphConfiguration.DEFAULT_CONNECTION_POOL_SIZE;
        
        /**
         * 重试次数
         */
        private int retryCount = NebulaGraphConfiguration.DEFAULT_RETRY_COUNT;
        
        /**
         * 重试间隔时间（毫秒）
         */
        private int retryIntervalMs = NebulaGraphConfiguration.DEFAULT_RETRY_INTERVAL_MS;
        
        /**
         * 会话超时时间（毫秒）
         */
        private int sessionTimeoutMs = NebulaGraphConfiguration.DEFAULT_SESSION_TIMEOUT_MS;
        
        /**
         * 空闲时间（毫秒）
         */
        private int idleTimeMs = NebulaGraphConfiguration.DEFAULT_IDLE_TIME_MS;
        
        /**
         * 健康检查间隔（毫秒）
         */
        private int healthCheckIntervalMs = NebulaGraphConfiguration.DEFAULT_HEALTH_CHECK_INTERVAL_MS;
        
        /**
         * 是否启用SSL
         */
        private boolean enableSsl = NebulaGraphConfiguration.DEFAULT_ENABLE_SSL;
        
        /**
         * 是否启用压缩
         */
        private boolean enableCompression = NebulaGraphConfiguration.DEFAULT_ENABLE_COMPRESSION;
        
        /**
         * 是否启用性能监控
         */
        private boolean enableMetrics = NebulaGraphConfiguration.DEFAULT_ENABLE_METRICS;
        ...
        public void validate() {
            ...
            if (retryIntervalMs < 0) {
                throw new IllegalArgumentException("Retry interval must be non-negative");
            }
            ...
            if (idleTimeMs < 0) {
                throw new IllegalArgumentException("Idle time must be non-negative");
            }
         ...
         * 获取距离函数枚举
         */
        public NebulaGraphQueryRequest.DistanceFunction getDistanceFunctionEnum() {
            return NebulaGraphQueryRequest.DistanceFunction.fromString(distanceFunction);
        }
        
        /**
         * 设置距离函数枚举
         */
        public void setDistanceFunctionEnum(NebulaGraphQueryRequest.DistanceFunction distanceFunction) {
     ...
     * 创建默认参数
     */
    public static NebulaGraphParam createDefault() {
     ...
     * 创建带维度的参数
     */
    public static NebulaGraphParam createWithDimension(int dimension) {
        NebulaGraphParam param = createDefault();
     ...
     * 创建带维度和相似度阈值的参数
     */
    public static NebulaGraphParam createWithDimensionAndThreshold(int dimension, double similarityThreshold) {
        NebulaGraphParam param = createWithDimension(dimension);
     ...
     * 创建用于测试的参数
     */
    public static NebulaGraphParam createForTesting() {
        NebulaGraphParam param = createDefault();
        ...
        initParam.setConnectionPoolSize(2);
        initParam.setTimeoutMs(10000);  // 测试时较短的超时时间
     ...
     * 复制参数
     */
    public NebulaGraphParam copy() {
        NebulaGraphParam copy = new NebulaGraphParam();
        ...
        if (this.initParam != null) {
            ...
            initParamCopy.setConnectionPoolSize(this.initParam.getConnectionPoolSize());
            initParamCopy.setRetryCount(this.initParam.getRetryCount());
            initParamCopy.setRetryIntervalMs(this.initParam.getRetryIntervalMs());
            initParamCopy.setSessionTimeoutMs(this.initParam.getSessionTimeoutMs());
            initParamCopy.setIdleTimeMs(this.initParam.getIdleTimeMs());
            initParamCopy.setHealthCheckIntervalMs(this.initParam.getHealthCheckIntervalMs());
            initParamCopy.setEnableSsl(this.initParam.isEnableSsl());
            initParamCopy.setEnableCompression(this.initParam.isEnableCompression());
            initParamCopy.setEnableMetrics(this.initParam.isEnableMetrics());
