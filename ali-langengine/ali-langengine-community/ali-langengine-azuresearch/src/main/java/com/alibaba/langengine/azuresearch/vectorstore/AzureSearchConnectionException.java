...
public class AzureSearchConnectionException extends AzureSearchException {

    private static final long serialVersionUID = 1L;

    public AzureSearchConnectionException(String message) {
        super("AZURE_SEARCH_CONNECTION_ERROR", message);
    }

    public AzureSearchConnectionException(String message, Throwable cause) {
        super("AZURE_SEARCH_CONNECTION_ERROR", message, cause);
    }
}