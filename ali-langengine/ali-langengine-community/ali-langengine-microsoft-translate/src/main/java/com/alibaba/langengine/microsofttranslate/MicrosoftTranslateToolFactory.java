...
import com.alibaba.langengine.microsofttranslate.tools.MicrosoftTranslateTool;
 ...
 */
@Slf4j
public class MicrosoftTranslateToolFactory {
    
    /**
     * 创建所有 Microsoft 翻译工具
     * 
     * @return 所有 Microsoft 翻译工具的列表
     */
    public List<BaseTool> getAllTools() {
        ...
        log.info("Created {} Microsoft Translate tools", tools.size());
        return tools;
    }
    ...
    public List<String> getSupportedToolTypes() {
        return Arrays.asList("microsoft_translate");
    }
    ...
    public BaseTool getTranslateTool() {
        return new MicrosoftTranslateTool();
    }
}
