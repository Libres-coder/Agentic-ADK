...
import com.alibaba.langengine.tencenttranslate.tools.TencentTranslateTool;
 ...
 */
@Slf4j
public class TencentTranslateToolFactory {
    ...
    public List<BaseTool> getAllTools() {
        ...
        log.info("Created {} Tencent Translate tools", tools.size());
        return tools;
    }
    ...
    public List<String> getSupportedToolTypes() {
        return Arrays.asList("tencent_translate");
    }
    ...
    public BaseTool getTranslateTool() {
        return new TencentTranslateTool();
    }
}
